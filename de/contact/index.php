...
<head>
    ...
    <meta name="description" content="Color Converter ist ein kleines Tool für Programmierer und Designer um Farben zu konvertieren.">
...
<body>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="../get-started">Jetzt loslegen</a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="Appointment">
                                <div class="main-menu d-none d-lg-block">
                                    <nav>
                                        <ul>
                                            <li><a href="../.."><img src="../img/flags/flag_de.png" class="flag"/> DE <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                ...
                                <div class="book_btn d-none d-lg-block">
                                    <a href="https://play.google.com/store/apps/details?id=com.mrgames13.jimdo.colorconverter" target="_blank">Herunterladen</a>
                                </div>
                            </div>
                        </div>
    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title wow fadeInUp">Kontakt aufnehmen</h2>
                </div>
                <div class="col-lg-8">
                    <?php
                        if(isset($_GET["success"])) {
                            echo("<p class=\"wow fadeInUp\" data-wow-delay=\".2s\">Erfolgreich gesendet!</p>");
                        } else if(isset($_GET["error"])) {
                            echo("<p class=\"wow fadeInUp\" data-wow-delay=\".2s\">Es ist ein Fehler aufgetreten! Bitte versuche es später erneut.</p>");
                        } else {
                            echo("<form class=\"form-contact contact_form\" action=\"contact_process.php\" method=\"post\" id=\"contactForm\">
                                ...
                                <div class=\"form-group mt-3\">
                                    <button type=\"submit\" class=\"button button-contactForm boxed-btn wow fadeInLeft\" data-wow-delay=\".4s\">Senden</button>
                                </div>
                            </form>");
                        }
                    ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            <h3 class="footer_title"><b>Downloads</b></h3>
                            <ul>
                                <li><a href="https://play.google.com/store/apps/details?id=com.mrgames13.jimdo.colorconverter" target="_blank">Von Google Play herunterladen</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
