                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <p><b>ChilliBits</b><br>Amalienstraße 6<br>76646 Bruchsal<br>Germany</p>
                        </div>
                    </div>
                    <div class="col-xl-2 offset-xl-1 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul>
                                <li><a href="url_web_version" target="_blank">Feinstaub-App Web</a></li>
                                <li><a href="https://github.com/chillibits/color-converter" target="_blank">App auf GitHub</a></li>
                                <li><a href="url_web_app_github" target="_blank">Web-App auf GitHub</a></li>
                                <li><a href="url_api_github" target="_blank">Feinstaub-API</a></li>
                            </ul>
                        </div>
                    </div>
