...
<head>
    ...
    <meta name="description" content="Color Converter is a small tool for programmers and designers to convert and pick colors.">
...
<body>
                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="Appointment">
                                <div class="main-menu d-none d-lg-block">
                                    <nav>
                                        <ul>
                                            <li><a href="../.."><img src="../img/flags/flag_en.png" class="flag"/> EN <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                ...
                                <div class="book_btn d-none d-lg-block">
                                    <a href="https://play.google.com/store/apps/details?id=com.mrgames13.jimdo.colorconverter" target="_blank">Download</a>
                                </div>
                            </div>
                        </div>
    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title wow fadeInUp">Get in touch</h2>
                </div>
                <div class="col-lg-8">
                    <?php
                        if(isset($_GET["success"])) {
                            echo("<p class=\"wow fadeInUp\" data-wow-delay=\".2s\">Sent successfully!</p>");
                        } else if(isset($_GET["error"])) {
                            echo("<p class=\"wow fadeInUp\" data-wow-delay=\".2s\">An error occured! Please try again later.</p>");
                        } else {
                            echo("<form class=\"form-contact contact_form\" action=\"contact_process.php\" method=\"post\" id=\"contactForm\">
                                ...
                                <div class=\"form-group mt-3\">
                                    <button type=\"submit\" class=\"button button-contactForm boxed-btn wow fadeInLeft\" data-wow-delay=\".4s\">Send</button>
                                </div>
                            </form>");
                        }
                    ?>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <p><a href="https://chillibits.com/en"><b>ChilliBits</b></a><br>Amalienstraße 6<br>76646 Bruchsal<br>Germany</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul>
                                <li><a href="https://play.google.com/store/apps/details?id=com.mrgames13.jimdo.colorconverter" target="_blank">Download from Play Store</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        &copy; ChilliBits <script>document.write(new Date().getFullYear());</script> - All rights reserved | powered by <a href="https://chillibits.com/en" target="_blank">ChilliBits</a>
                        </p>
                    </div>
                </div>
            </div>
